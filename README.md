...
**Cette documentation fourni une méthodologie pour mettre en place une plateforme collaborative Sync-in conteneurisée dans une infrastructure d'authentification centralisée avec FreeIPA**
...
- Création d'une image personalisée pour l'intégration du certificat auto-signé du serveur FreeIPA nécessaire aux connexions LDAPS
